...
export const Navigation = () => {
  ...
  return <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "bg-background/95 backdrop-blur-lg shadow-ocean" : "bg-transparent"}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? <>
                ...
                <Button className="bg-gradient-ocean hover:shadow-ocean transition-all" onClick={() => navigate('/research-portal')}>
                  Dashboard
                </Button>
              </> : <>
